...
- **Deny-by-default**: `.gitignore` ignores everything except explicitly whitelisted paths. Currently only `kitty/`, `herdr/`, `karabiner/`, `ghostty/`, `git/`, and `mise/` are tracked.
