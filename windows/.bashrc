...
# Functions (i, clone, gd, yz, glp, etc.) now in ~/.config/dotfiles/functions.sh — sourced at EOF for consistency
# See dotfiles/functions.sh for shared helpers (also used by macOS zsh)
